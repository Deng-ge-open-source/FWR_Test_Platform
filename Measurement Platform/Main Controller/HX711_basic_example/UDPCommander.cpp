...
void SendWeight(IPAddress ipClient, IPAddress ipServidor,String read_1,String read_2,String read_3,String read_4,String sum_total)
{
   ...
   const char * replyPacket3 = read_3.c_str();
   const char * replyPacket4 = read_4.c_str();
   const char * replyPacket5 = sum_total.c_str();
   ...
   Udp.printf("\t");
   Udp.printf(replyPacket3);
   Udp.printf("\t"); 
   Udp.printf(replyPacket4);
   Udp.printf("\t"); 
   Udp.printf(replyPacket5);
   Udp.printf("\t"); 
   Udp.printf("65");
   Udp.printf("\t");
   Udp.endPacket(); 
